...
--
-- Servidor: localhost
-- Tiempo de generación: 18-07-2015 a las 06:12:31
...
INSERT INTO `cursos` (`ID_CURSO`, `ID_AREA`, `ID_CATEGORIA`, `CI_EMPLEADO`, `NOMBRE_CURSO`, `HORA_INICIO`, `HORA_FIN`) VALUES
(1, NULL, NULL, NULL, 'Base de Datos', '14:00', '18:00'),
(2, NULL, NULL, NULL, 'Ingenieria de Software', '12:00', '15:00'),
(3, NULL, NULL, NULL, 'Sistemas Operativos', '14:00', '16:00');
...
INSERT INTO `matriculas` (`ID_MATRICULA`, `CI`, `ID_PERIODO`, `ID_PAGO`, `ID_CURSO`, `ESTADO`, `NOTA_FINAL`) VALUES
(1, '1111', 1, 1, 1, 'Aprobado', 22);
...
(2, '1111', 'Alexander', 'Sanchez', '1995-09-05'),
...
ALTER TABLE `matriculas`
  ...
  ADD KEY `FK_RELATIONSHIP_4` (`ID_PAGO`);
